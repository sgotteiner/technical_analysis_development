...
class BacktestService:
    ...
    def execute_backtest(
        ...
        print(f"     - Median Return (50%) : {metrics['median_return']:+.2f}%")
        print(f"     - 33rd Percentile     : {metrics['p33_return']:+.2f}%")
        print(f"     - 66th Percentile     : {metrics['p66_return']:+.2f}%")
        print(f"     - Mean Return         : {metrics['mean_return']:+.2f}%")
        print(f"     - Min / Max Return    : {metrics['min_return']:+.2f}% / {metrics['max_return']:+.2f}%")
        print("-------------------------------------------------------------------------")
        print("  6. COMPARED TO BUY & HOLD BENCHMARK:")
