...
def run_backtest(request: BacktestRequestSchema):
    ...
    return BacktestResultSchema(
        ...
        mean_return_pct=res["mean_return"],
        median_return_pct=res["median_return"],
        p33_return_pct=res["p33_return"],
        p66_return_pct=res["p66_return"],
        min_return_pct=res["min_return"],
        max_return_pct=res["max_return"],
